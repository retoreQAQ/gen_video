...
2.6 请以纯JSON格式回复，不要包含任何其他字符或格式标记，尤其是开头和结尾。格式如下：
{{
    "scenes": [
        {{
            "scene_number": 0,
            "scene_detail": "根据每段原文生成场景描述",
            "prompt": "根据场景描述生成提示词，如："上海美术制片厂风格，竖屏9:16。主角××（外观设定）正在××（动作），神情为××。背景为××，周围有××物件。场景时间为××，天气××，整体色调为××，细节如××突出。儿童插图，国风，水墨线条，细节丰富。（可自行优化）""
        }}
    ]
}}
"""
